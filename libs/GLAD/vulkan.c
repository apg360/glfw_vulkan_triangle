...
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    if (glad_vkBindAccelerationStructureMemoryKHR == NULL && glad_vkBindAccelerationStructureMemoryNV != NULL) glad_vkBindAccelerationStructureMemoryKHR = (PFN_vkBindAccelerationStructureMemoryKHR)glad_vkBindAccelerationStructureMemoryNV;
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    if (glad_vkBindAccelerationStructureMemoryNV == NULL && glad_vkBindAccelerationStructureMemoryKHR != NULL) glad_vkBindAccelerationStructureMemoryNV = (PFN_vkBindAccelerationStructureMemoryNV)glad_vkBindAccelerationStructureMemoryKHR;
#endif
...
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    if (glad_vkCmdWriteAccelerationStructuresPropertiesKHR == NULL && glad_vkCmdWriteAccelerationStructuresPropertiesNV != NULL) glad_vkCmdWriteAccelerationStructuresPropertiesKHR = (PFN_vkCmdWriteAccelerationStructuresPropertiesKHR)glad_vkCmdWriteAccelerationStructuresPropertiesNV;
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    if (glad_vkCmdWriteAccelerationStructuresPropertiesNV == NULL && glad_vkCmdWriteAccelerationStructuresPropertiesKHR != NULL) glad_vkCmdWriteAccelerationStructuresPropertiesNV = (PFN_vkCmdWriteAccelerationStructuresPropertiesNV)glad_vkCmdWriteAccelerationStructuresPropertiesKHR;
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
...
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    if (glad_vkDestroyAccelerationStructureKHR == NULL && glad_vkDestroyAccelerationStructureNV != NULL) glad_vkDestroyAccelerationStructureKHR = (PFN_vkDestroyAccelerationStructureKHR)glad_vkDestroyAccelerationStructureNV;
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    if (glad_vkDestroyAccelerationStructureNV == NULL && glad_vkDestroyAccelerationStructureKHR != NULL) glad_vkDestroyAccelerationStructureNV = (PFN_vkDestroyAccelerationStructureNV)glad_vkDestroyAccelerationStructureKHR;
#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
#endif
